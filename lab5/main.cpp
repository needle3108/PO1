/*
 Celem zadania jest przećwiczenie funkcji wirtualnych i dziedziczenia wielokrotnego. 
...
W ramach dokumentacji w pliku main.h proszę uzasadnić zastosowaną hierarchię, w tym też pliku może się też znaleźć się funkcja wspólna draw. Pozostałą strukturę plików pozostawiam Państwu do decyzji, jednak proszę nie pisać każdej klasy w osobnym pliku, lecz pogrupować je na np klasy abstrakcyjne (z funkcjami abstrakcyjnymi) i poszczególnych obiektów. 
...
// #define ERROR2  // do odkomentowania

int main() {
	const Point p(1.5, 3.0);
	std::cout << "Punkt " << p << std::endl;
	// Koło o promieniu 3 i środku p
	Circle kolo(p, 3); 					
